...
class bm():
    ...
    def find_bpm(self):
        ...
        for value in enumerate(uninherited_timing_points_times):
            ...
            try:
                diffs.append([uninherited_timing_points_times[value[0]][0], int(uninherited_timing_points_times[value[0] + 1][0]) - round(float(uninherited_timing_points_times[value[0]][0])), round(1 / float(uninherited_timing_points_times[value[0]][1]) * 1000 * 60)])
            except IndexError:
